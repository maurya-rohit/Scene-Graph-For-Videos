...
def add_arguments(parser):
    ...
    parser.add_argument("--graph_name", type=str, default=str(time.time()), help="Specify file name.")
...
plt.xlabel('Iteration') # Num steps 
path = '/home/rupsha_8/text-summarization-tensorflow/graphs/'
plt.savefig(path + args.graph_name)
# plt.show()